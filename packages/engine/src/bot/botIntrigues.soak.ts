...
/* Порог победы задан явно: окно вето висит 5 с на каждое действие, и партия
   до пяти корон шла бы больше десяти минут реального времени. На трёх она
   успевает закончиться — а заодно проверяется, что боты играют по правилам
   партии, а не по зашитым числам. */
