 ...
 *
 * Крупная надпись «КИНГСЛЕР» вписана в сам постер, поэтому в разметке её нет —
 * дублировать значило бы показать её дважды. Мелкая подпись в подвале нужна на
 * случай выключенных картинок: письмо должно назвать себя и без них.
 *
...
<![endif]-->
  ...
  <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr><td align="center" style="padding:18px 26px 24px 26px;font-family:${serif};font-size:11px;letter-spacing:3px;color:${GOLD};">
